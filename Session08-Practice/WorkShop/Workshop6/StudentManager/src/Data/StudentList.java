...
public class StudentList extends ArrayList<Student> {
    ...
    public void addStudent() {
        ...
        int newMark;
        do {
            newCode = Inpputer.inputPattern("St. code s000: ", "[sS][\\d]{3}");
            newCode = newCode.trim().toUpperCase();
            if (isCodeDupplicated(newCode)) {
                System.out.println("Code is duplicated!");
            }
        } while (isCodeDupplicated(newCode));
        newName = Inpputer.inputNoBlankStr("Name of new student: ");
        newName = newName.trim().toUpperCase();
        newMark = Inpputer.inputInt("Mark: ", 0, 10);
    ...
    public void searchStudent() {
        if (this.isEmpty()) {
            ...
            String sCode = Inpputer.inputStr("Input student code for search: ");
    ...
    public void updateStudent() {
        if (this.isEmpty()) {
            ...
            String uCode = Inpputer.inputStr("Input code of updateed student: ");
            ...
            if (st == null) {
                ...
                String newName = Inpputer.inputNoBlankStr(msg);
                st.setName(newName);
                int oldMark = st.getMark();
                msg = "Old mark: " + oldMark + ", new mark 0..10: ";
                int newMark = Inpputer.inputInt(msg, 0, 10);
                st.setMark(newMark);
    ...
    public void removeStudent() {
        if (this.isEmpty()) {
            ...
            String rCode = Inpputer.inputStr("Input code of removed student: ");
